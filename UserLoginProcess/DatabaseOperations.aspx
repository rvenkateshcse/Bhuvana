<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DatabaseOperations.aspx.cs" Inherits="UserLoginProcess.DatabaseOperations" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Select" runat="server" Text="Select" OnClick="Select_Click" style="height: 26px" />
        </p>
        <p>
            &nbsp;</p>
        <p>
